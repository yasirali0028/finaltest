            ...
            <div className="row justify-content-center">
              ...
              <div className="col-lg-4 col-12">
                <div className="px-4 pb-3"> 
                  <img src="Images/Rectangle 5.png" width="100%" alt="cremees" />
                </div>
              </div>
              <div className="col-11 message_box">
                <div className="row justify-content-between align-items-center">
                  ...
                  <div className="col-lg-4 col-12 text_right">
                    <button className="btn_connect red_btn">Join Discord</button>
                  </div>
                </div>
              </div>
            </div>
          </div>
          <div className="ice_cream_section">
            <div className="container-fluid">
              <p className="ice_cream_heading">Hero</p>
              <div className="row">
                <div className="col-lg-12 col-12 py-4">
                  <p className="ice_cream_para">
                  ...
                  <Link to="/connect" className="d-block text-center text-decoration-none btn_connect blue_btn mt-4">Join Discord</Link>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="container-fluid">
              ...
              <div className="row">
                ...
                <div className="col-lg-8 col-12 py-4">
                  ...
                  <button className="btn_connect blue_btn mt-4">Join Discord</button>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="modal-dialog modal-fullscreen">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <p><a href="#ice_cream_section">ICE CREAM LOVERS UNITE!</a></p>
                <p><a href="#opensea_section">MEET THE CREEMEES</a></p>
                <p><a href="#roadmap_section">ROADMAP</a></p>
                <p><a href="#faq_section">FAQ</a></p>
              </div>
            </div>
          </div>
        </div>
